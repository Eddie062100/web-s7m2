      ...
      <div id="membersForm">
        ...
        <form onSubmit={onSubmit}>
          <div>
            ...
            <input onChange={onChange} id="fname" type="text" value={values.fname} placeholder="Type First Name" />
          </div>

          <div>
            <label htmlFor="lname">Last Name </label>
            <input onChange={onChange} id="lname" type="text" value={values.lname} placeholder="Type Last Name" />
          </div>

          <div>
            <label htmlFor="bio">Bio </label>
          <textarea onChange={onChange} id="bio" value={values.bio} placeholder="Type Bio" />~1234
          </div>
